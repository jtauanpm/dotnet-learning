...
public class AuthController : MainController
{
    ...
    private async Task<LoginOutput> GerarJwt(string email)
    {
    ...
    private LoginOutput ObterRespostaToken(string encodedToken, IdentityUser user, IEnumerable<Claim> claims)
    {
