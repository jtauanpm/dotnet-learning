...
public class MultiTenancyDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        // was used with TenantId column strategy
        // modelBuilder.Entity<Person>().HasQueryFilter(e => e.TenantId == TenantDataProvider.TenantId);
        // modelBuilder.Entity<Product>().HasQueryFilter(e => e.TenantId == TenantDataProvider.TenantId);
    }
}